                  ...
                  Obx(() {
                    switch (dashData.getStatus) {
                      ...
                      case Status.COMPLETED:
                        ClientInfo clientInfo = dashData.getDashboard.clientInfo!;
                        return Container(
                                                ...
                                                child: RichText(
                                                  text: TextSpan(
                                                    children: [
                                                      ...
                                                      TextSpan(
                                                        text: 'Rs. ${clientInfo.projectCost ?? 0.00}',
                                                        style: FlutterFlowTheme.of(context)
                                                            .bodyLarge,
                                                      )
                                                    ],
